...
public class FavoriteJobActivity extends AppCompatActivity {
    ...
    private String current_url, type;
    ...
    private void getData(String url) {
        ...
        if (url.equals("") && type.equals("favorite")) {
            url = Constant.FAVORITE_JOB_LIST_URL;
        } else if (type.equals("applied")) {
            url = Constant.APPLIED_JOB_LIST_URL;
        }
...
//                        End pagination
                        ...
                        jobsAdapter = new JobsAdapter(activity, jobsModelArrayList, "removeFavorite");
                        recyclerView.setAdapter(jobsAdapter);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                    Log.d("efJobs", e.getMessage());
                }
            }
            Log.d("rfJobs", response);
