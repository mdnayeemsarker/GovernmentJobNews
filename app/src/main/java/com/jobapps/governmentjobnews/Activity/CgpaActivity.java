...
import com.jobapps.governmentjobnews.Adapter.CgpaPageAdapter;
...
public class CgpaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CgpaPageAdapter cgpaPageAdapter = new CgpaPageAdapter(getSupportFragmentManager());
        viewPager.setAdapter(cgpaPageAdapter);
